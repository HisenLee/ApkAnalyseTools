...
public class Third_Party_Enabling_Report_SheetThree {
    ...
    public static void generate(String apkFileDir, ArrayList<AppInfo> appInfos,
        ...
        ExcelOperation resultExcel = new ExcelOperation(
                FileOperation.generateResultXlsName("./", Third_Party_Enabling_Report_SheetThree.class.getSimpleName()));
        ...
        for (AppInfo info : appInfos) {
            ...
            if (apk.isX86LibMismatchApp()) {
                ArrayList<NativeLib> mismatchedLibs = apk.getMismatchedX86Libs();
